...
ds00 <- read_rds(here("01_Data/ds_4studies.rds")) |> 
  mutate(manuscript = case_when(
    manuscript == "1: Rafii, 2015" ~ "a: Rafii, 2015",
    manuscript == "2: Packer, 2017" ~ "b: Packer, 2017",
    manuscript == "3: Mao, 2020" ~ "c: Mao, 2020",
    manuscript == "4: Wu, 2024" ~ "d: Wu, 2024",
  ))
```
...
run_stan_model <- function(data, manuscript, 
                           stan_file = "04_Script/estimate_bayes_stan_flat_plateau.stan",
                           betakp_lower = 0.5,
                           betakp_upper = 2,
                           chains = 4,
                           iter = 4000,
...
print(combined_plot)
ggsave(here("03_Output/fig1.tiff"), dpi = 400, width = 7, height = 5)
